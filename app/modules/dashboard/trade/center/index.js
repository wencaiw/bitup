...
module.exports = {
    ...
    views: {
        'trade': {
            ...
            controller: ['$scope', '$http', '$cookies', '$state', '$', 'line', function($scope, $http, $cookies, $state, $, line){
                ...
                $http.get("/app/modules/dashboard/trade/data/dac.list.php").then(function (res) {
                    if (res.data.resultCode == 0) {
                        ...
                        $scope.info.line.startDate($scope.info.getStartDate($scope.info.currTab));
